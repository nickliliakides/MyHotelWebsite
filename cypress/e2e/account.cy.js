...
describe('Cypress google login and account page test', () => {
  it('should login to google successfully and account pages to be accessible', () => {
    cy.visit('/login');
    // google login
    cy.login();
    ...
    // Go to reservations and reservations container ih visible
    ...
    // Should be redirected to '/' and 'Guest Area' in the navigation should be visible when there is not logged in user
